...
namespace server.Models.Dtos
{
    public class CreateCarDto
    {
        ...
        [RegularExpression(@"^[авекмнорстухАВЕКМНОРСТУХ][0-9]{3}[авекмнорстухАВЕКМНОРСТУХ]{2}[0-9]{2,3}$", ErrorMessage = "Невалидный формат государственного номера автомобиля")]
        public string? StateNumber { get; set; }

        [Required(ErrorMessage = "Бренд автомобиля обязателен")]
        [StringLength(30, ErrorMessage = "Длина бренда автомобиля должна быть не больше 30 символов")]
