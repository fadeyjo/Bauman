...
// CAN
#define CAN_BUS_PIN_NUM_MISO 19
#define CAN_BUS_PIN_NUM_MOSI 23
#define CAN_BUS_PIN_NUM_CLK  18
#define CAN_BUS_PIN_NUM_CS   4
#define CAN_BUS_PIN_NUM_INT  2
