...
static constexpr auto qt_meta_stringdata_ZN4RoomE = QtMocHelpers::stringData(
    "Room",
    "sendMessage",
    "",
    "receive",
...
Q_CONSTINIT static const uint qt_meta_data_ZN4RoomE[] = {
...
Q_CONSTINIT const QMetaObject Room::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4RoomE.offsetsAndSizes,
    qt_meta_data_ZN4RoomE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4RoomE_t,
        // Q_OBJECT / Q_GADGET
...
void *Room::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4RoomE.stringdata0))
