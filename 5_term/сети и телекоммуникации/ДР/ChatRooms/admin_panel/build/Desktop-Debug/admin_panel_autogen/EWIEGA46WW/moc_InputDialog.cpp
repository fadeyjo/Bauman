...
static constexpr auto qt_meta_stringdata_ZN11InputDialogE = QtMocHelpers::stringData(
    "InputDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11InputDialogE[] = {
...
Q_CONSTINIT const QMetaObject InputDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11InputDialogE.offsetsAndSizes,
    qt_meta_data_ZN11InputDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11InputDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *InputDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11InputDialogE.stringdata0))
